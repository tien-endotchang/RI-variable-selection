...
All analysis scripts are located in the `main/` directory. Results are automatically saved to the `results/` directory. Note that the global random seed is set to **42** for all simulation settings.

### 1. Part I: Variable Ranking (Paper Section 4.2)
...
### 2. Part II: Modeling (Paper Section 4.3)
...
```
**Output:** Table 3 in the paper (saved to `results/tab/`).
